...
class RopeMoverTest {
    ...
    @Test
    fun `should move  all knots with test input`() {
        ...
        val ropePosition: RopePosition2 = RopeMover().moveAll(input.lines())

        assertThat((ropePosition.visited.size)).isEqualTo(1)
    }


    @Test
    fun `should move  all knots with large test input`() {
        ...
        assertThat((ropePosition.visited.size)).isEqualTo(36)
    }
}
