...
class SignalStrengthCalculatorTest {
    ...
    fun `should parse test input for part 2`() {
        ...
        val input = """
            ...
            noop
        """.trimIndent()
        val image: String = SignalStrengthCalculator().printImage(input.lines())
...
//        assertThat(strength).isEqualTo(13140)
    ...
    @Test
    fun `should parse part 2 input`() {

        val input = ReadInputHelper.readLinesFromResource("/day10/signal.txt")

        val image: String = SignalStrengthCalculator().printImage(input)
